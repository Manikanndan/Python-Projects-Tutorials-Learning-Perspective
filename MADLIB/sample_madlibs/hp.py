def madlib():
    ...
    body_part_2 = input("Body part: ")
    verb = input("Verb: ")
    verb_past_1 = input("Verb (past tense): ")
    verb_past_2 = input("Verb (past tense): ")
    spell1 = input("Spell: ")
    spell2 = input("Spell: ")


    madlib = f"A {adj1} glow burst suddenly across the enchanced sky above them as an edge of \
        dazzling sun appeared over the sill of the nearest {noun1}. The light hit both of their {body_part_1} \
        at the same time, so that Voldemort's was suddenly a flaming {noun2}. Harry heard the high voice \
        shriek as he {verb_past_1} his best hope to the heavens, pointing Draco's {noun3}:\n\
        \"{spell1}!\"\n\
        \"{spell2}!\"\n\
        ...
        of the {adj4} {body_part_2} rolling upward. Tom Riddle hit the floor with a mundane finality, his body \
        feeble and shrunken, the white hands empty, the snakelike face vacant and unknowing. Voldemort \
        was dead, {verb_past_2} by his own rebounding {noun5}, and harry stood with two wands in his hands, \
