def madlib():
    ...
    madlib = f"{number} seconds. That's how long we're required to {verb1} on our metal circles before \
    the sound of a {noun1} releases us. Step off before the {number} seconds is up, and {noun_plural_1} blow your \
    legs off. {number} seconds to take in the ring of tributes all equidistant from the {sound_important}, a gaint \
