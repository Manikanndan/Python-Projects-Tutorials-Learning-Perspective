def madlib():
    ...
    madlib = f"I love programming because it's {adj1}! The journey to becoming a \
        ...
        from developing {adj3} software to analyzing data and making predicitions about the {noun2}. You can \
